...
class ConsoleGridViewSuite extends UnitSuite {
  test("A GridView should be able to display a 9x9 grid") {
  ...
  test("A GridView should be able to display a 4x4 grid") {
    val gridController = GridController(4, 4)
    val gridView = ConsoleGridView(gridController)
    val expected = """x----x----x----x----x
                     || 00 | 01 | 02 | 03 |
                     |x----x----x----x----x
                     || 04 | 05 | 06 | 07 |
                     |x----x----x----x----x
  ...
  test("A GridView should be able to display a 6x6 grid") {
    val gridController = GridController(6, 6)
    val gridView = ConsoleGridView(gridController)
    val expected = """x----x----x----x----x----x----x
                     || 00 | 01 | 02 | 03 | 04 | 05 |
                     |x----x----x----x----x----x----x
                     || 06 | 07 | 08 | 09 | 10 | 11 |
                     |x----x----x----x----x----x----x
